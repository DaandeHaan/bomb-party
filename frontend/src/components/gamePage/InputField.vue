<template>
  <div class="w-full bottom-12 px-6 gap-4 flex justify-center flex-col">
    ...
    <div class="flex flex-row md:flex-row items-center justify-center gap-4">
      <!-- Input Field -->
      <input
      ...
      <button
        ...
        class="md:hidden py-3 px-6 rounded-lg bg-gradient-to-r from-[#7AA2F7] to-[#BB9AF7] text-[#1E1E2E] font-semibold shadow-md hover:scale-105 disabled:opacity-50 transition-all duration-300"
      >
        Send Word
      </button>
    </div>
